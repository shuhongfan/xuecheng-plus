...
CREATE TABLE `course_base`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程基本信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of course_base
-- ----------------------------
INSERT INTO `course_base` VALUES (1, 1232141425, NULL, 'JAVA8/9/10新特性讲解', 'java爱好者,有一定java基础', '有个java 版本变化的新内容，帮助大家使用最新的思想和工具', '1', '1-3-2', '204002', '200002', NULL, 'https://cdn.educba.com/academy/wp-content/uploads/2018/08/Spring-BOOT-Interview-questions.jpg', '2019-09-03 17:48:19', '2022-09-17 16:47:29', '1', NULL, '202004', '203001');
...
INSERT INTO `course_base` VALUES (18, 1232141425, NULL, 'java零基础入门', 'java小白java小白java小白java小白', 'aa', '1-3', '1-3-2', '200001', '200002', 'java零基础入门java零基础入门java零基础入门java零基础入门', '/mediafiles/2022/09/13/a16da7a132559daf9e1193166b3e7f52.jpg', '2019-09-04 09:56:19', '2022-09-15 17:43:18', NULL, NULL, '202004', '203001');
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '课程-教师关系表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `teachplan`  (
  ...
  `change_date` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 267 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程计划' ROW_FORMAT = DYNAMIC;
